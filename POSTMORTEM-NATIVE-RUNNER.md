...
**Status:** IN PROGRESS (Attempt 5 - Multi-Method Process Detection)
**Date:** 2025-12-29
**Platform:** macOS ARM64 (Apple Silicon)
**Gale Version:** Latest main branch
**Last Updated:** 2025-12-29 - Added lsof-based process detection
...
The root cause is that native runners on macOS exit before Post steps complete. Despite multiple fix attempts, the child process detection mechanism (`pgrep -f`) appears to not find the running processes. The next investigator should focus on understanding the actual process hierarchy and finding a reliable way to detect when ALL job-related processes have truly completed.
